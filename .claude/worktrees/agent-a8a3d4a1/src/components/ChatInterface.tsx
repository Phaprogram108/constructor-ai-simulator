...
export default function ChatInterface({
    ...
    try {
      ...
      if (!response.ok) {
        if (data.code === 'CHAT_LIMIT_REACHED') {
          ...
          // Don't remove the user message - it was sent but limit was hit
  ...
  return (
    <div className="flex flex-col h-screen max-h-screen bg-white">
      ...
      {/* Weekly limit banner */}
      {weeklyLimitReached && (
        <div className="mx-4 mb-2 bg-amber-50 border border-amber-200 text-amber-800 text-sm p-4 rounded-lg">
          <p className="font-medium mb-2">
            Llegaste al l&iacute;mite de testeo gratuito semanal (20 mensajes).
          </p>
          <p className="mb-3">
            Si quer&eacute;s un agente para tu empresa, contactanos.
          </p>
          <a
            href={WHATSAPP_URL}
            target="_blank"
