    ...
    >
      <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white px-4 py-2 rounded-full text-xs sm:text-sm font-semibold transition-colors"
        >
