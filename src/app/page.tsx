      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex gap-3 overflow-x-auto pb-4 snap-x snap-mandatory" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none', WebkitOverflowScrolling: 'touch' }}>
            {[
              { id: 'DWCPoC2Doxq', title: 'Reel 1' },
              { id: 'DWCPbO-jjZt', title: 'Reel 2' },
              { id: 'DWCPL_ODnWC', title: 'Reel 3' },
              { id: 'DVx7n17iF8g', title: 'Reel 4' },
              { id: 'DVwf8GlCBQ_', title: 'Reel 5' },
              { id: 'DVuT5AdkXMI', title: 'Reel 6' },
              { id: 'DVs94XaAtSg', title: 'Reel 7' },
              { id: 'DVrZWWUFU11', title: 'Reel 8' },
              { id: 'DVrB4j8jo_o', title: 'Reel 9' },
            ].map((reel) => (
              <a
                key={reel.id}
                ...
                className="flex-shrink-0 snap-center w-[200px] md:w-[240px] h-[350px] md:h-[420px] rounded-xl overflow-hidden relative group cursor-pointer"
              >
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
                  ...
                  <span className="text-white/80 text-sm font-medium">Ver en Instagram</span>
                </div>
